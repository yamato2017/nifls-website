...
const hostelFees = [
  { room: "单人间", price: "57,000日元 / 月" },
  { room: "双人间", price: "47,000日元 / 月" },
  { room: "3～4人间", price: "42,000日元 / 月" },
  { room: "5人间", price: "37,000日元 / 月" },
];
            ...
            >
              ...
              <div className="mt-5 flex items-start gap-2 sm:gap-3 lg:mt-6 lg:gap-5">
                <div className="text-center">
                  ...
                  <span className="whitespace-nowrap text-[13px] font-semibold tracking-[0.03em] text-[#0C477D] sm:text-[16px] lg:text-[21px] lg:tracking-[0.07em]">
                    学习
                  </span>
                </div>
          ...
          <div className="relative z-10 mx-auto max-w-[1450px]">
            <div className="grid items-center gap-8 lg:grid-cols-[1.08fr_0.92fr]">
              ...
              <div
                ...
                "
              >
                <div className="absolute bottom-[-8px] left-0 top-[-8px] w-[72px] rounded-l-[22px] bg-[#082F69] sm:w-[90px] lg:bottom-[-10px] lg:top-[-10px] lg:w-[105px] lg:rounded-l-[26px]" />

                <div className="absolute bottom-[10px] left-[30px] right-[5px] top-[10px] rounded-[20px] border-2 border-[#E0B13C] sm:left-[40px] sm:right-[8px] sm:rounded-[23px] lg:bottom-[14px] lg:left-[48px] lg:right-[12px] lg:top-[14px] lg:rounded-[26px]" />

                <div className="absolute bottom-[15px] left-[39px] right-[2px] top-[5px] overflow-hidden rounded-[18px] bg-white shadow-[0_14px_32px_rgba(7,54,111,0.14)] sm:left-[52px] sm:right-[4px] sm:rounded-[21px] lg:bottom-[19px] lg:left-[62px] lg:right-[8px] lg:top-[8px] lg:rounded-[23px] lg:shadow-[0_18px_42px_rgba(7,54,111,0.14)]">
                  <Image
                    src="/bbq1.jpg"
                    alt="名古屋国际外语学院 校园生活"
                    fill
              ...
              <div>
                ...
                <h2 className="mt-2 text-[34px] font-semibold tracking-[0.05em] text-[#07366F] sm:mt-3 sm:text-[38px] lg:text-[40px] lg:tracking-[0.06em]">
                  校园里的每一天
                </h2>
                ...
                <p className="mt-4 text-[13px] font-medium leading-[1.9] text-[#4E687D] sm:mt-5 sm:text-[14px] sm:leading-[2]">
                  课堂从日语基础到实际应用循序渐进地学习，
                  培养升入大学、研究生院及专门学校所需的各项能力。
                </p>

                <div className="mt-5 grid grid-cols-3 gap-2 sm:mt-6 sm:gap-3">
                  {["日语课程", "升学指导", "自习・学习支持"].map((item) => (
                    <div
                      key={item}
                      className="rounded-[12px] border border-[#D5E4EE] bg-white px-2 py-3 text-center shadow-[0_6px_16px_rgba(20,77,115,0.06)] sm:rounded-[13px] sm:px-4 sm:py-4"
                    >
                ...
                {/* STUDY SPACE */}
                <div className="mt-4 grid grid-cols-[105px_1fr] overflow-hidden rounded-[14px] border border-[#D4E4EE] bg-white shadow-[0_8px_22px_rgba(21,76,115,0.07)] sm:mt-5 sm:grid-cols-[150px_1fr] sm:rounded-[16px]">
        ...
        <section className="relative overflow-hidden bg-white px-5 py-14 sm:px-8 lg:px-10">
          ...
          <div className="relative mx-auto grid max-w-[1400px] items-center gap-10 lg:grid-cols-[0.82fr_1.18fr]">
            ...
            <div>
              ...
              <h2 className="mt-4 text-[38px] font-semibold tracking-[0.07em] text-[#07366F]">
                校园活动
              </h2>
