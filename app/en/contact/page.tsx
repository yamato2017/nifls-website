...
const schools = [
  {
    ...
    address: "30-18 Tatsumi-cho, Minato-ku, Nagoya, Aichi 455-0003, Japan",
    tel: "052-355-9981",
    fax: "052-355-9982",
    accent: "#082F69",
  },
  {
    label: "Chitose School",
    en: "CHITOSE SCHOOL",
    image: "/schoolchitoseko.jpg",
    address: "1-45 Tatsumi-cho, Minato-ku, Nagoya, Aichi 455-0003, Japan",
    tel: "052-888-8686",
    fax: "052-888-8687",
    accent: "#1597A0",
  },
      ...
      <main className="min-h-screen bg-[#F7FBFE] text-[#082F69]">
        ...
        <section className="relative overflow-hidden bg-[#EAF6FC]">
          <div className="relative mx-auto h-[330px] max-w-[1760px] overflow-hidden">
            <Image
              src="/herocontact.jpg"
              alt="Contact Nagoya International Foreign Language School"
              fill
              priority
              sizes="100vw"
            ...
            <div className="relative z-10 flex h-full items-center px-[6%]">
              <div>
                ...
                <h1
                  className="mt-4 text-[46px] font-semibold tracking-[0.02em] text-[#07366F] sm:text-[50px]"
                  style={{
                ...
                <p className="mt-5 max-w-[560px] text-[15px] font-semibold leading-[1.9] text-[#294B68] sm:text-[16px]">
                  Please feel free to contact us with any questions about
                  admissions, student life, or studying at NIFLS.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="relative overflow-hidden bg-[linear-gradient(180deg,#F7FBFE_0%,#EEF7FC_55%,#F7FBFE_100%)] px-5 py-12 sm:px-8 lg:px-10">
          ...
          <div className="relative z-10 mx-auto max-w-[1450px]">
            <div className="mb-9 text-center">
              ...
              <h2
                className="mt-2 text-[36px] font-semibold tracking-[0.02em] text-[#07366F]"
                style={{
                  fontFamily: 'Georgia,"Times New Roman",serif',
                }}
              >
                  ...
                  <div className="relative overflow-hidden rounded-[22px] border border-[#C9DDE9] bg-white shadow-[0_18px_44px_rgba(15,68,107,0.15)]">
                    <div className="grid min-h-[350px] md:grid-cols-[42%_58%]">
                      ...
                      <div className="relative min-h-[330px] overflow-hidden bg-[#E8F3F9]">
                        <Image
                          src={school.image}
                          alt={`Nagoya International Foreign Language School - ${school.label}`}
                          fill
                      ...
                      <div className="relative flex flex-col justify-center bg-[linear-gradient(135deg,#FFFFFF_0%,#F7FBFE_65%,#EDF7FC_100%)] p-7">
                        ...
                        <div className="relative z-10">
                          ...
                          <h3
                            className="mt-2 text-[30px] font-semibold tracking-[0.02em] text-[#07366F]"
                            style={{
                              fontFamily: 'Georgia,"Times New Roman",serif',
                            }}
                          >
                ...
                <div className="flex items-center gap-4 border-y border-white/10 px-6 py-5 lg:border-x lg:border-y-0">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-[12px] font-bold leading-[1.7] text-white">
                      Tokai-dori Station, Meiko Line
                      <br />
                      <span className="text-[#F0BD46]">
        ...
        {/* =====================================================
            SNS
        ===================================================== */}
        <section className="relative overflow-hidden bg-white px-5 py-10 sm:px-8 lg:px-10">
        ...
        <section
          id="access"
          className="relative overflow-hidden bg-[#EEF7FC] px-5 py-12 sm:px-8 lg:px-10 lg:py-14"
        >
          ...
          <div className="relative z-10 mx-auto max-w-[1450px]">
            ...
            <div className="mb-8 text-center lg:mb-10">
              ...
              <h2
                className="mt-3 text-[32px] font-semibold tracking-[0.02em] text-[#07366F] sm:text-[38px] lg:text-[42px]"
                style={{
                  fontFamily: 'Georgia,"Times New Roman",serif',
                }}
              >
              ...
              <p className="mx-auto mt-3 max-w-[650px] text-[12px] font-medium leading-[1.8] text-[#61798B] sm:text-[13px]">
                Access information for the Main School and Chitose School of
                Nagoya International Foreign Language School.
              </p>
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <div className="relative overflow-hidden rounded-[24px] border border-[#C9DFEA] bg-white shadow-[0_16px_38px_rgba(7,54,111,0.10)]">
                ...
                <div className="relative px-5 pb-4 pt-6 sm:px-6">
                  ...
                  <div className="relative flex items-end gap-3">
                    <h3
                      className="text-[27px] font-semibold tracking-[0.02em] text-[#07366F]"
                      style={{
                        fontFamily: 'Georgia,"Times New Roman",serif',
                      }}
                    >
                ...
                <div className="mx-4 overflow-hidden rounded-[17px] border border-[#D5E4EC] bg-[#EAF4F9] sm:mx-5">
                  <iframe
                    title="Nagoya International Foreign Language School Main School Google Map"
              ...
              <div className="relative overflow-hidden rounded-[24px] border border-[#C9DFEA] bg-white shadow-[0_16px_38px_rgba(7,54,111,0.10)]">
                ...
                <div className="mx-4 overflow-hidden rounded-[17px] border border-[#D5E4EC] bg-[#EAF4F9] sm:mx-5">
                  <iframe
                    title="Nagoya International Foreign Language School Chitose School Google Map"
