...
const featured2026: DocumentItem[] = [
  ...
  {
    title: "List of Course Completers",
    category: "Course Completion",
    file: "/katei26.pdf",
  },
  {
    title: "2026 JLPT First Test Results",
    category: "JLPT",
    file: "/jlpt2601.pdf",
  },
  {
    title: "2026 JLPT Second Test Results",
    category: "JLPT",
    file: "/jlpt2602.pdf",
  },
];
...
const recentYears: ArchiveYear[] = [
  {
    ...
    items: [
      ...
      {
        title: "2025 JLPT First Test Results",
        category: "JLPT",
        file: "/jlpt2501.pdf",
      },
      {
        title: "2025 JLPT Second Test Results",
        category: "JLPT",
        file: "/jlpt2502.pdf",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        title: "2024 JLPT First Test Results",
        category: "JLPT",
        file: "/jlpt2401.pdf",
      },
      {
        title: "2024 JLPT Second Test Results",
        category: "JLPT",
        file: "/jlpt2402.pdf",
      },
    ],
...
const archiveYears: ArchiveYear[] = [
  {
    ...
    items: [
      ...
      {
        title: "2023 JLPT First Test Results",
        category: "JLPT",
        file: "/jlpt2301.pdf",
      },
      {
        title: "2023 JLPT Second Test Results",
        category: "JLPT",
        file: "/jlpt2302.pdf",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        title: "2022 JLPT First Test Results",
        category: "JLPT",
        file: "/jlpt2201.pdf",
      },
      {
        title: "2022 JLPT Second Test Results",
        category: "JLPT",
        file: "/jlpt2202.pdf",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        title: "2021 JLPT First Test Results",
        category: "JLPT",
        file: "/jlpt2101.pdf",
      },
      {
        title: "2021 JLPT Second Test Results",
        category: "JLPT",
        file: "/jlpt2102.pdf",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        title: "2020 JLPT First Test Results",
        category: "JLPT",
        file: "/jlpt2001.pdf",
      },
      {
        title: "2020 JLPT Second Test Results",
        category: "JLPT",
        file: "/jlpt2002.pdf",
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        title: "2019 JLPT First Test Results",
        category: "JLPT",
        file: "/jlpt1901.pdf",
      },
      {
        title: "2019 JLPT Second Test Results",
        category: "JLPT",
        file: "/jlpt1902.pdf",
      },
    ],
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-0.5 text-[9px] font-bold text-[#93A1AC]">
              {year.items.length} Published Documents
            </p>
          </div>
        </div>
          ...
          <div className="grid min-h-[360px] lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className="relative z-20 flex items-center bg-[#071F43] px-6 py-14 sm:px-10 lg:px-14 xl:pl-[8vw]">
              ...
              <div className="relative max-w-[620px]">
                ...
                <h1 className="mt-5 text-[44px] font-black leading-none tracking-[0.02em] text-white sm:text-[56px] lg:text-[64px]">
                  Public Information
                </h1>

                <p className="mt-6 max-w-[590px] text-[12.5px] font-medium leading-[2] text-white/65 sm:text-[13px]">
                  View documents published by the school, including
                  self-assessment reports, lists of course completers, and
                  JLPT results.
                </p>
          ...
          <div className="mx-auto grid max-w-[1500px] overflow-hidden rounded-[18px] border border-[#D9E5EC] bg-white shadow-[0_18px_45px_rgba(7,36,72,.12)] md:grid-cols-3">
            ...
            <div className="relative flex items-center gap-4 border-b border-[#E0E8ED] px-5 py-5 md:border-b-0 md:border-r lg:px-7">
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] font-medium text-[#778B9A]">
                  Access documents from previous years
                </p>
              </div>
            </div>
            ...
            <div className="relative flex items-center gap-4 px-5 py-5 lg:px-7">
              ...
              <div>
                ...
                <p className="mt-1 text-[10px] font-medium text-[#778B9A]">
                  Clear and accurate public information
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid gap-6 lg:grid-cols-[250px_1fr]">
              <div>
                ...
                <p className="mt-4 text-[10.5px] font-medium leading-[1.8] text-[#718493]">
                  Select an academic year to view the documents published for
                  that year.
                </p>
              </div>
          ...
          <div className="mx-auto max-w-[1500px] px-5 sm:px-8 lg:px-12">
            <div className="mb-6">
              ...
              <p className="mt-3 text-[10.5px] font-medium text-[#718493]">
                View published documents by academic year from 2019 through
                2023.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-[1500px] px-5 sm:px-8 lg:px-12">
            <div className="flex flex-col gap-3 rounded-[14px] border border-[#DCE6EB] bg-[#F7FAFC] px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
              <p className="text-[10px] font-medium text-[#718493]">
                If you have any questions regarding the published documents,
                please contact us.
              </p>
