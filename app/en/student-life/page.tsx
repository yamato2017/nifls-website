...
const hostelFees = [
  { room: "Single Room", price: "¥57,000 / Month" },
  { room: "2-Person Room", price: "¥47,000 / Month" },
  { room: "3–4 Person Room", price: "¥42,000 / Month" },
  { room: "5-Person Room", price: "¥37,000 / Month" },
];
        ...
        <section className="relative overflow-hidden bg-[#EAF6FC]">
          ...
          >
            ...
            >
              <Image
                src="/sports4.jpg"
                alt="Student life at Nagoya International Foreign Language School"
                fill
                priority
            ...
            >
              ...
              <div className="mt-5 flex items-start gap-2 sm:gap-3 lg:mt-6 lg:gap-5">
                ...
                <div className="text-center">
                  ...
                  <span className="whitespace-nowrap text-[13px] font-semibold text-[#0C477D] sm:text-[16px] lg:text-[21px]">
                    Study
                  </span>
                </div>
          ...
          <div className="relative z-10 mx-auto max-w-[1450px]">
            <div className="grid items-center gap-8 lg:grid-cols-[1.08fr_0.92fr]">
              ...
              >
                ...
                >
                  <Image
                    ...
                    className="object-cover object-[50%_48%] sm:object-center lg:object-center"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <p className="mt-3 text-[15px] font-bold leading-[1.8] text-[#244B6B] sm:mt-4 sm:text-[16px] lg:text-[17px]">
                  Learn Japanese and prepare for your next academic step.
                </p>

                <div className="mt-4 h-[2px] w-12 bg-[#D6A22E]" />

                <p className="mt-4 text-[13px] font-medium leading-[1.9] text-[#4E687D] sm:mt-5 sm:text-[14px] sm:leading-[2]">
                  Students learn Japanese progressively from basic to advanced
                  levels while developing the skills needed to enter
                  universities, graduate schools, and vocational schools in
                  Japan.
                </p>
                  ...
                  <div className="flex items-center p-4 sm:p-5">
                    <div>
                      ...
                      <p className="mt-2 text-[10px] font-medium leading-[1.7] text-[#637A8C] sm:text-[11px]">
                        Students can continue studying toward their personal
                        goals outside class hours.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-[1450px]">
            <div className="mb-8 text-center">
              ...
              <h2
                className="mt-2 text-[38px] font-semibold tracking-[0.02em] text-[#07366F]"
                style={{
                  fontFamily: 'Georgia,"Times New Roman",serif',
                }}
              >
              ...
              <p className="mt-3 text-[14px] font-semibold text-[#48677F]">
                A comfortable living environment for starting your new life in
                Japan
              </p>
            </div>
            ...
            <div className="grid overflow-hidden rounded-[24px] border border-[#D2E3ED] bg-white shadow-[0_16px_42px_rgba(18,71,107,0.11)] lg:grid-cols-[46%_54%]">
              ...
              <div className="relative bg-[linear-gradient(135deg,#FFFFFF_0%,#F3FAFE_100%)] p-7 lg:p-9">
                <div className="grid gap-3 sm:grid-cols-2">
                  {[
                    ["Convenient Commute", "7–15 minutes from the school"],
                    ["Free Wi-Fi", "Comfortable internet access"],
                    ["Dedicated Cafeteria", "Reliable daily meals"],
                    ["Living Facilities", "Facilities for everyday life"],
                  ].map(([title, text]) => (
                    <div
                      key={title}
            ...
            <div className="mt-5 grid grid-cols-2 gap-3 md:grid-cols-4">
              {hostelGallery.map((src, index) => (
                ...
                >
                  <Image
                    src={src}
                    alt={`Student dormitory facility ${index + 1}`}
                    fill
        ...
        <section className="relative overflow-hidden bg-[#EEF7FC] px-5 py-14 sm:px-8 lg:px-10">
          ...
          <div className="relative z-10 mx-auto max-w-[1400px]">
            <div className="mb-8 text-center">
              ...
              <p className="mt-3 text-[14px] font-semibold text-[#48677F]">
                Reliable meals for everyday student life
              </p>
            </div>
            ...
            <div className="mt-5 grid overflow-hidden rounded-[18px] border border-[#466E97] bg-[#082F69] shadow-[0_12px_28px_rgba(7,54,111,0.16)] md:grid-cols-3">
              {[
                ...
                ["2 Choices per Meal", "Choose from two menu options"],
                ["Dedicated Cafeteria", "A comfortable dining environment"],
        ...
        <section className="relative overflow-hidden bg-white px-5 py-14 sm:px-8 lg:px-10">
          ...
          <div className="relative mx-auto grid max-w-[1400px] items-center gap-10 lg:grid-cols-[0.82fr_1.18fr]">
            ...
            <div>
              ...
              <h2
                className="mt-4 text-[38px] font-semibold tracking-[0.02em] text-[#07366F]"
                style={{
                  fontFamily: 'Georgia,"Times New Roman",serif',
                }}
              >
              ...
              <p className="mt-6 max-w-[560px] text-[14px] font-medium leading-[2] text-[#536E82]">
                In addition to studying, students have opportunities to
                experience Japanese culture and society through school events
              ...
              <div className="mt-7 grid grid-cols-2 gap-3">
                {[
                  ["SPRING", "Spring", "Enrollment & New Beginnings"],
                  ["SUMMER", "Summer", "Interaction & Off-School Activities"],
                  [
                    "AUTUMN",
                    "Autumn",
                    "Cultural Experiences & Academic Preparation",
                  ],
                  [
                    "WINTER",
                    "Winter",
                    "Learning Achievements & Graduation Preparation",
                  ],
                ].map(([en, season, text], index) => (
                  <div
                    key={en}
        ...
        <section className="bg-[#EEF7FC] px-5 py-9 sm:px-8 lg:px-10">
          <div className="mx-auto flex max-w-[1100px] flex-col items-center justify-between gap-5 overflow-hidden rounded-[20px] border border-[#476F99] bg-[#082F69] px-7 py-6 text-white shadow-[0_13px_30px_rgba(7,54,111,0.17)] md:flex-row">
            <div>
              ...
              >
                Start Your New Student Life at NIFLS.
              </p>
            </div>
