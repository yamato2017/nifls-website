...
const INTERVIEW_URL = "/en/contact";

const flow = [
  {
    title: "Check Requirements",
    en: "REQUIREMENTS",
    text: "Confirm the application requirements",
    icon: "check",
  },
  {
  ...
  },
  {
    ...
    en: "SCREENING",
    text: "Document review and interview",
    icon: "document",
  },
  {
    title: "Selection",
    en: "SELECTION",
    text: "Selection conducted by the school",
    icon: "select",
  },
  {
    title: "COE Application",
    en: "COE APPLICATION",
    text: "Application submitted to Immigration",
    icon: "file",
  },
  {
    title: "COE Issuance",
    en: "COE ISSUANCE",
    text: "Certificate of Eligibility issued",
    icon: "card",
  },
  {
    title: "Tuition Payment & Visa",
    en: "PAYMENT & VISA",
    text: "Pay tuition and apply for a visa",
    icon: "yen",
  },
  {
    title: "Arrival & Enrollment",
    en: "ARRIVAL",
    text: "Arrive in Japan and begin school life",
    icon: "plane",
  },
];
        ...
        <section className="relative bg-[linear-gradient(180deg,#FFFFFF_0%,#F1F9FD_100%)] px-5 py-10 sm:px-8">
          <div className="mx-auto max-w-[1480px]">
            <div className="mb-7 text-center">
              ...
              <h2 className="mt-2 text-[32px] font-black tracking-[0.02em] text-[#07366F]">
                Application Requirements
              </h2>
            </div>
              ...
              <div className="grid lg:grid-cols-4">
                ...
                <div className="border-b border-[#DCE9F1] p-6 lg:border-b-0 lg:border-r">
                  ...
                  <div className="mt-5 space-y-2.5 text-[12px] font-bold leading-[1.7] text-[#4D697E]">
                    <p>
                      ✓ Must have completed, or be expected to complete, 12
                      years of education
                    </p>
                    ...
                    <p>
                      ✓ Must submit academic transcripts from high school
                      and/or university
                    </p>

                    <p>✓ Preference will be given to applicants with English proficiency</p>
                  </div>
                </div>
                ...
                <div className="border-b border-[#DCE9F1] bg-[#F5FBFE] p-6 lg:border-b-0 lg:border-r">
                  ...
                  <div className="mt-5 flex items-center gap-3">
                    ...
                    <div className="flex-1 rounded-[13px] bg-[#07366F] px-3 py-3 text-center text-white">
                      ...
                      <p className="text-[9px] font-bold">Required</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-b border-[#DCE9F1] p-6 lg:border-b-0 lg:border-r">
                  ...
                  <div className="mt-5 space-y-2.5 text-[12px] font-bold leading-[1.7] text-[#4D697E]">
                    <p>✓ Applicants must be in good health</p>

                    <p>
                      ✓ A tuberculosis (TB) screening may be required depending
                      on the applicant&apos;s country
                    </p>

                    <p className="font-black text-[#D6473E]">
                      × Applicants with tattoos are not eligible to apply
                    </p>

                    <p className="font-black text-[#D6473E]">
                      × Applicants with full-time work experience are not eligible
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-[#F5FBFE] p-6">
                  ...
                  <div className="mt-5 space-y-3 text-[12px] font-bold leading-[1.7] text-[#4D697E]">
                    <p>
                      ✓ The financial sponsor must have a stable source of
                      income
                    </p>
                    ...
                    <p>
                      ✓ Applicants must comply with Japanese laws and school
                      rules
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col items-center justify-between gap-4 border-t border-[#D9E7EF] bg-[#EAF6FC] px-6 py-4 sm:flex-row">
                <div>
                  ...
                  <p className="mt-1 text-[13px] font-bold text-[#315877]">
                    Please refer to the Application Guidelines for detailed
            ...
            <div className="grid overflow-hidden rounded-[17px] border border-white/15 bg-[#0A417D] md:grid-cols-4">
              {[
                [
                  "SCREENING FEE",
                  "¥27,500 (Tax Included)",
                  "Payment required before the COE application",
                ],
                [
                  "STUDENT DORMITORY",
                  "Mandatory for 2 Years",
                  "School-designated student dormitory",
                ],
                [
                  "MEALS",
                  "3 Meals a Day",
                  "Included in the dormitory fee on class days",
                ],
                [
                  "TUITION",
                  "Lump-Sum Payment",
                  "Monthly installment payments are not available",
                ],
                ...
                >
                  ...
                  <p className="mt-2 text-[18px] font-black text-[#EDB833]">
                    {main}
                  </p>
              ...
              <div className="flex flex-col items-center justify-between gap-5 px-7 py-6 md:flex-row md:px-10">
                <div>
                  ...
                  <h2 className="mt-2 text-[23px] font-black text-white">
                    Apply for an Online Interview
                  </h2>

                  <p className="mt-2 text-[12px] font-bold leading-[1.8] text-[#D3E3EE]">
                    After confirming the application requirements, applicants
                    who wish to have an online interview may proceed to the
                    application page.
                  </p>
                </div>
        ...
        <section className="bg-white px-5 py-10 sm:px-8">
          <div className="mx-auto max-w-[1500px]">
            <div className="mb-7 text-center">
              ...
              <h2 className="mt-2 text-[31px] font-black tracking-[0.02em] text-[#07366F]">
                Admission Process
              </h2>
            </div>
