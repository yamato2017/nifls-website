const universities = [
  {
    name: "Meiji University Graduate School",
  ...
  {
    name: "Showa Women's University Graduate School",
...
const automotiveSchools = [
  {
    name: "Toyota Nagoya Automotive College",
    href: "https://toyota-tcn.ac.jp/",
  },
  {
    name: "Nissan Aichi Automotive College",
    href: "https://www.nissan-gakuen.ac.jp/aichi/",
  },
  {
    name: "Meitetsu Automotive College",
...
const supportLinks = [
  ...
  {
    name: "Daily Life Support Portal for Foreign Nationals",
    sub: "Information for Living in Japan",
    ...
    <section className="relative overflow-hidden bg-[#f7fbfe] px-5 py-11 sm:px-8 lg:px-10">
      <div className="relative z-10 mx-auto max-w-[1500px]">
        ...
        <div className="mb-7 text-center">
          ...
          <h2
            className="mt-2 text-[34px] font-semibold tracking-[0.03em] text-[#07366f]"
            style={{
              fontFamily:
