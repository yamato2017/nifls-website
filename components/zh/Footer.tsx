...
export default function Footer() {
  const navigation = [
    ...
    ["学校介绍", "/zh/about"],
    ["课程介绍", "/zh/courses"],
    ["校园生活", "/zh/student-life"],
    ["学费", "/zh/tuition"],
    ["资料下载", "/zh#documents"],
    ["主要升学去向", "/zh/student-life#career"],
    ["联系我们", "/zh/contact"],
  ];
      ...
      <div className="mx-auto max-w-[1450px] px-6 py-9 lg:px-10">
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr_1fr]">
          ...
          <div>
            ...
            <h3 className="mt-2 text-[18px] font-bold">页面导航</h3>
          ...
          <div>
            ...
            <h3 className="mt-2 text-[18px] font-bold">联系我们</h3>

            <div className="mt-5 space-y-2.5">
              {/* ADDRESS */}
              <div className="rounded-[11px] border border-[#4D76A1] bg-[#0B376F] px-4 py-3">
                <p className="text-[9px] font-bold text-[#65C9F6]">地址</p>
              ...
              <div className="grid gap-2.5 sm:grid-cols-2">
                ...
                >
                  <p className="text-[9px] font-bold text-[#65C9F6]">TEL</p>
                ...
                {/* EMAIL */}
                <div className="rounded-[11px] border border-[#4D76A1] bg-[#0B376F] px-4 py-3">
                  <p className="text-[9px] font-bold text-[#65C9F6]">EMAIL</p>
        ...
        <div className="mt-8 flex flex-col gap-2 border-t border-white/15 pt-5 text-[9px] text-[#8DA9C2] sm:flex-row sm:items-center sm:justify-between">
          <p>
            © 2026 Nagoya International Foreign Language School. All Rights
            Reserved.
          </p>
